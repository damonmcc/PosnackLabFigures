...
df = pandas.read_csv('rhythm_score.csv')
...
averp = np.loadtxt('mehp_averp.csv', delimiter=',', skiprows=1, usecols=(2,3))
...
wbcl = np.loadtxt('mehp_wbcl.csv', delimiter=',', skiprows=1, usecols=(2,3))
...
snrt = np.loadtxt('mehp_snrt.csv', delimiter=',', skiprows=1, usecols=(2,3))
